...
export const mockContinuedAsNewEventHistory = {
  history: {
    events: [
      {
        eventId: '1',
      ...
      },
      {
        ...
        workflowExecutionCompletedEventAttributes: {
          ...
          identity: '168773@user0@',
          newExecutionRunId: '4284ef9a-947f-4db2-bf15-dbc377e71fa6',
          prevAutoResetPoints: null,
          header: {
            fields: {},
          },
...
export const EVENT_HISTORY_API =
  /\/api\/v1\/namespaces\/[^/]+\/workflows\/[^/]+\/history\?.*$/;

export const EVENT_HISTORY_API_REVERSE =
  /\/api\/v1\/namespaces\/[^/]+\/workflows\/[^/]+\/history-reverse\?.*$/;

export const mockEventHistoryApi = (
  page: Page,
  history: GetWorkflowExecutionHistoryResponse = mockEventHistory,
) => {
