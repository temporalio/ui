...
export const ScheduleInfo = z.object({
  ...
  actionCount: z.string().describe('Number of actions taken so far.').optional(),
  /**Number of times a scheduled action was skipped due to missing the catchup window.*/
  missedCatchupWindow: z
    .string()
    .describe('Number of times a scheduled action was skipped due to missing the catchup window.')
    .optional(),
  /**Number of skipped actions due to overlap.*/
  overlapSkipped: z.string().describe('Number of skipped actions due to overlap.').optional(),
  /**Number of dropped actions due to buffer limit.*/
  bufferDropped: z.string().describe('Number of dropped actions due to buffer limit.').optional(),
  /**
  ...
  recentActions: z
    .array(z.any())
    .describe('Most recent ten actual action times (including manual triggers).')
    .optional(),
