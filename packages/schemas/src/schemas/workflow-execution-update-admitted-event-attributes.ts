...
export const WorkflowExecutionUpdateAdmittedEventAttributes = z.object({
  ...
  request: z.any().describe('The update request associated with this event.').optional(),
  /**An explanation of why this event was written to history.*/
  origin: z
    .enum(['UPDATE_ADMITTED_EVENT_ORIGIN_UNSPECIFIED', 'UPDATE_ADMITTED_EVENT_ORIGIN_REAPPLY'])
