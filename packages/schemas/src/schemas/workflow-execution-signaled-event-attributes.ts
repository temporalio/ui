...
export const WorkflowExecutionSignaledEventAttributes = z.object({
  ...
  signalName: z.string().describe('The name/type of the signal to fire').optional(),
  /**Will be deserialized and provided as argument(s) to the signal handler*/
  input: z
    .any()
    .describe('Will be deserialized and provided as argument(s) to the signal handler')
    .optional(),
  /**id of the worker/client who sent this signal*/
  identity: z.string().describe('id of the worker/client who sent this signal').optional(),
  /**
  ...
  skipGenerateWorkflowTask: z
    .boolean()
    .describe('This field is deprecated and never respected. It should always be set to false.')
    .optional(),
