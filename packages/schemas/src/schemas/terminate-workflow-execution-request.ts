...
export const TerminateWorkflowExecutionRequest = z.object({
  ...
  details: z
    .any()
    .describe('Serialized additional information to attach to the termination event')
    .optional(),
  ...
  links: z
    .array(z.any())
    .describe('Links to be associated with the WorkflowExecutionTerminated event.')
    .optional(),
});
export type TerminateWorkflowExecutionRequest = z.infer<typeof TerminateWorkflowExecutionRequest>;
