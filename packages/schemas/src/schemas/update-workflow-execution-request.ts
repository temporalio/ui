...
export const UpdateWorkflowExecutionRequest = z
  .object({
    ...
    namespace: z.string().describe('The namespace name of the target Workflow.').optional(),
    /**
...
export type UpdateWorkflowExecutionRequest = z.infer<typeof UpdateWorkflowExecutionRequest>;
