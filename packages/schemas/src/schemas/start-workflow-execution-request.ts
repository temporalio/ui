...
export const StartWorkflowExecutionRequest = z.object({
  ...
  workflowExecutionTimeout: z
    ...
    .describe('Total workflow execution timeout including retries and continue as new.')
    .optional(),
  ...
  identity: z.string().describe('The identity of the client who initiated this request').optional(),
  ...
  retryPolicy: z
    .any()
    .describe('The retry policy for the workflow. Will never exceed `workflow_execution_timeout`.')
    .optional(),
  /**See https://docs.temporal.io/docs/content/what-is-a-temporal-cron-job/*/
  cronSchedule: z
    .string()
    .describe('See https://docs.temporal.io/docs/content/what-is-a-temporal-cron-job/')
    .optional(),
  memo: z.any().optional(),
  ...
  links: z.array(z.any()).describe('Links to be associated with the workflow.').optional(),
  /**
...
export type StartWorkflowExecutionRequest = z.infer<typeof StartWorkflowExecutionRequest>;
