...
export const ActivityTaskStartedEventAttributes = z.object({
  ...
  scheduledEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_SCHEDULED` event this task corresponds to')
    .optional(),
  /**id of the worker that picked up this task*/
  identity: z.string().describe('id of the worker that picked up this task').optional(),
  /**TODO ??*/
...
export type ActivityTaskStartedEventAttributes = z.infer<typeof ActivityTaskStartedEventAttributes>;
