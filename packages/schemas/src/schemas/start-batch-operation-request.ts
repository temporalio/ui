...
export const StartBatchOperationRequest = z.object({
  ...
  namespace: z.string().describe('Namespace that contains the batch operation').optional(),
  /**
  ...
  jobId: z.string().describe('Job ID defines the unique ID for the batch job').optional(),
  /**Reason to perform the batch operation*/
  reason: z.string().describe('Reason to perform the batch operation').optional(),
  /**
...
export type StartBatchOperationRequest = z.infer<typeof StartBatchOperationRequest>;
