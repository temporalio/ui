...
export const BatchOperationUnpauseActivities = z
  ...
  .describe('BatchOperationUnpauseActivities sends unpause requests to batch workflows.');
export type BatchOperationUnpauseActivities = z.infer<typeof BatchOperationUnpauseActivities>;
