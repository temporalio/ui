...
export const DescribeBatchOperationResponse = z.object({
  ...
  completeOperationCount: z.string().describe('Complete operation count').optional(),
  /**Failure operation count*/
  failureOperationCount: z.string().describe('Failure operation count').optional(),
  /**Identity indicates the operator identity*/
  identity: z.string().describe('Identity indicates the operator identity').optional(),
  /**Reason indicates the reason to stop a operation*/
  reason: z.string().describe('Reason indicates the reason to stop a operation').optional(),
});
export type DescribeBatchOperationResponse = z.infer<typeof DescribeBatchOperationResponse>;
