...
export const WorkerDeploymentVersionInfo = z
  .object({
    ...
    taskQueueInfos: z
      .array(z.any())
      .describe('All the Task Queues that have ever polled from this Deployment version.')
      .optional(),
    /**
...
export type WorkerDeploymentVersionInfo = z.infer<typeof WorkerDeploymentVersionInfo>;
