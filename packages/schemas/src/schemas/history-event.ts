...
export const HistoryEvent = z
  .object({
    ...
    eventId: z.string().describe('Monotonically increasing event number, starts at 1.').optional(),
    ...
    version: z.string().describe('TODO: What is this? Appears unused by SDKs').optional(),
    /**TODO: What is this? Appears unused by SDKs*/
    taskId: z.string().describe('TODO: What is this? Appears unused by SDKs').optional(),
    /**
    ...
    links: z.array(z.any()).describe('Links associated with the event.').optional(),
    ...
    requestCancelExternalWorkflowExecutionInitiatedEventAttributes: z.any().optional(),
    requestCancelExternalWorkflowExecutionFailedEventAttributes: z.any().optional(),
