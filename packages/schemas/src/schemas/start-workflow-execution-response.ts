...
export const StartWorkflowExecutionResponse = z.object({
  ...
  started: z.boolean().describe('If true, a new workflow was started.').optional(),
  /**
...
export type StartWorkflowExecutionResponse = z.infer<typeof StartWorkflowExecutionResponse>;
