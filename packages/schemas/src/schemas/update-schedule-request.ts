...
export const UpdateScheduleRequest = z.object({
  ...
  namespace: z.string().describe('The namespace of the schedule to update.').optional(),
  /**The id of the schedule to update.*/
  scheduleId: z.string().describe('The id of the schedule to update.').optional(),
  /**
  ...
  requestId: z
    .string()
    .describe('A unique identifier for this update request for idempotence. Typically UUIDv4.')
    .optional(),
  /**
