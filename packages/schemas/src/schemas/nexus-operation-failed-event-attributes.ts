...
export const NexusOperationFailedEventAttributes = z
  .object({
    ...
    failure: z
      .any()
      .describe('Failure details. A NexusOperationFailureInfo wrapping an ApplicationFailureInfo.')
      .optional(),
    /**The request ID allocated at schedule time.*/
    requestId: z.string().describe('The request ID allocated at schedule time.').optional(),
  })
