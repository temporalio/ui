...
export const RequestCancelExternalWorkflowExecutionFailedEventAttributes = z.object({
  cause: z
    .enum([
...
export type RequestCancelExternalWorkflowExecutionFailedEventAttributes = z.infer<
  typeof RequestCancelExternalWorkflowExecutionFailedEventAttributes
>;
