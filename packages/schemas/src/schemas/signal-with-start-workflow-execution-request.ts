...
export const SignalWithStartWorkflowExecutionRequest = z.object({
  ...
  requestId: z.string().describe('Used to de-dupe signal w/ start requests').optional(),
  /**
  ...
  signalName: z
    .string()
    .describe('The workflow author-defined name of the signal to send to the workflow')
    .optional(),
  /**Serialized value(s) to provide with the signal*/
  signalInput: z.any().describe('Serialized value(s) to provide with the signal').optional(),
  /**Deprecated*/
