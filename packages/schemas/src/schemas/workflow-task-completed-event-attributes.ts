...
export const WorkflowTaskCompletedEventAttributes = z.object({
  ...
  identity: z.string().describe('Identity of the worker who completed this task').optional(),
  /**Binary ID of the worker who completed this task*/
  binaryChecksum: z.string().describe('Binary ID of the worker who completed this task').optional(),
  /**
