...
export const ActivityTaskTimedOutEventAttributes = z.object({
  ...
  scheduledEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_SCHEDULED` event this timeout corresponds to')
    .optional(),
  /**The id of the `ACTIVITY_TASK_STARTED` event this timeout corresponds to*/
  startedEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_STARTED` event this timeout corresponds to')
    .optional(),
  retryState: z
    .enum([
