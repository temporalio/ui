...
export const ScheduleSpec = z
  .object({
    ...
    cronString: z
      ...
      .optional(),
    /**Calendar-based specifications of times.*/
    calendar: z.array(z.any()).describe('Calendar-based specifications of times.').optional(),
    /**Interval-based specifications of times.*/
    interval: z.array(z.any()).describe('Interval-based specifications of times.').optional(),
    ...
    endTime: z
      .string()
      .datetime({ offset: true })
      .describe('If end_time is set, any timestamps after end_time will be skipped.')
      .optional(),
    /**
