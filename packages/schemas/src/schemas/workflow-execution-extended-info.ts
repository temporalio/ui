...
export const WorkflowExecutionExtendedInfo = z
  .object({
    ...
    lastResetTime: z
      .string()
      .datetime({ offset: true })
      .describe('Last workflow reset time. Nil if the workflow was never reset.')
      .optional(),
...
export type WorkflowExecutionExtendedInfo = z.infer<typeof WorkflowExecutionExtendedInfo>;
