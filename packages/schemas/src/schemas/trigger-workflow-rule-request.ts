...
export const TriggerWorkflowRuleRequest = z.object({
  ...
  spec: z
    .any()
    .describe('Note: Rule ID and expiration date are not used in the trigger request.')
    .optional(),
});
export type TriggerWorkflowRuleRequest = z.infer<typeof TriggerWorkflowRuleRequest>;
