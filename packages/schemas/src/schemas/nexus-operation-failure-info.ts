...
export const NexusOperationFailureInfo = z.object({
  ...
  scheduledEventId: z.string().describe('The NexusOperationScheduled event ID.').optional(),
  /**Endpoint name.*/
  ...
  operationToken: z
    .string()
    .describe('Operation token - may be empty if the operation completed synchronously.')
    .optional(),
});
export type NexusOperationFailureInfo = z.infer<typeof NexusOperationFailureInfo>;
