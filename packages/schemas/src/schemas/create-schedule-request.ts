...
export const CreateScheduleRequest = z
  .object({
    ...
    namespace: z.string().describe('The namespace the schedule should be created in.').optional(),
    ...
    initialPatch: z
      .any()
      .describe('Optional initial patch (e.g. to run the action once immediately).')
      .optional(),
    ...
    requestId: z
      .string()
      .describe('A unique identifier for this create request for idempotence. Typically UUIDv4.')
      .optional(),
