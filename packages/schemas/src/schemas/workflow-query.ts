...
export const WorkflowQuery = z
  .object({
    ...
    queryType: z
      .string()
      .describe('The workflow-author-defined identifier of the query. Typically a function name.')
      .optional(),
    /**Serialized arguments that will be provided to the query handler.*/
    queryArgs: z
      .any()
      .describe('Serialized arguments that will be provided to the query handler.')
      .optional(),
    /**
