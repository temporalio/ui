...
export const RecordActivityTaskHeartbeatByIdRequest = z.object({
  ...
  workflowId: z.string().describe('Id of the workflow which scheduled this activity').optional(),
  /**Run Id of the workflow which scheduled this activity*/
  runId: z.string().describe('Run Id of the workflow which scheduled this activity').optional(),
  /**Id of the activity we're heartbeating*/
  activityId: z.string().describe("Id of the activity we're heartbeating").optional(),
  /**Arbitrary data, of which the most recent call is kept, to store for this activity*/
  details: z
    .any()
    .describe('Arbitrary data, of which the most recent call is kept, to store for this activity')
    .optional(),
