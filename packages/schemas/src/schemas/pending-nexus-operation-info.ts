...
export const PendingNexusOperationInfo = z
  ...
  .describe('PendingNexusOperationInfo contains the state of a pending Nexus operation.');
export type PendingNexusOperationInfo = z.infer<typeof PendingNexusOperationInfo>;
