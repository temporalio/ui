...
export const ActivityTaskCanceledEventAttributes = z.object({
  ...
  details: z
    .any()
    .describe('Additional information that the activity reported upon confirming cancellation')
    .optional(),
  /**
  ...
  startedEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_STARTED` event this cancel confirmation corresponds to')
    .optional(),
  /**id of the worker who canceled this activity*/
  identity: z.string().describe('id of the worker who canceled this activity').optional(),
  /**
