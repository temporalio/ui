...
export const DescribeTaskQueueResponse = z.object({
  ...
  taskQueueStatus: z.any().describe('Deprecated. Not set in `ENHANCED` mode.').optional(),
  /**
...
export type DescribeTaskQueueResponse = z.infer<typeof DescribeTaskQueueResponse>;
