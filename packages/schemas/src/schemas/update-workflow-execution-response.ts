...
export const UpdateWorkflowExecutionResponse = z.object({
  ...
  updateRef: z
    .any()
    .describe('Enough information for subsequent poll calls if needed. Never null.')
    .optional(),
  /**
...
export type UpdateWorkflowExecutionResponse = z.infer<typeof UpdateWorkflowExecutionResponse>;
