...
export const WorkflowExecutionStartedEventAttributes = z
  .object({
    ...
    parentInitiatedEventId: z
      .string()
      .describe('EventID of the child execution initiated event in parent workflow')
      .optional(),
    taskQueue: z.any().optional(),
    /**SDK will deserialize this and provide it as arguments to the workflow function*/
    input: z
      .any()
      .describe('SDK will deserialize this and provide it as arguments to the workflow function')
      .optional(),
    ...
    identity: z.string().describe('Identity of the client who requested this execution').optional(),
    /**
    ...
    attempt: z
      .number()
      .int()
      .describe('Starting at 1, the number of times we have tried to execute this workflow')
      .optional(),
    /**
    ...
    versioningOverride: z
      .any()
      .describe('Versioning override applied to this workflow when it was started.')
      .optional(),
    /**
