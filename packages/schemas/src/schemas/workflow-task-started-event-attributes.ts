...
export const WorkflowTaskStartedEventAttributes = z.object({
  ...
  identity: z.string().describe('Identity of the worker who picked up this task').optional(),
  /**TODO: ? Appears unused?*/
...
export type WorkflowTaskStartedEventAttributes = z.infer<typeof WorkflowTaskStartedEventAttributes>;
