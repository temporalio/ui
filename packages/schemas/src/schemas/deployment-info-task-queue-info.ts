...
export const DeploymentInfo_TaskQueueInfo = z.object({
  ...
  firstPollerTime: z
    ...
    .describe('When server saw the first poller for this task queue in this deployment.')
    .optional(),
});
export type DeploymentInfo_TaskQueueInfo = z.infer<typeof DeploymentInfo_TaskQueueInfo>;
