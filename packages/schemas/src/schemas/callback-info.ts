...
export const CallbackInfo = z
  .object({
    ...
    callback: z
      .any()
      .describe('Information on how this callback should be invoked (e.g. its URL and type).')
      .optional(),
  ...
  .describe('CallbackInfo contains the state of an attached workflow callback.');
