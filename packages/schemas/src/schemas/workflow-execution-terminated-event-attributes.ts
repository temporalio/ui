...
export const WorkflowExecutionTerminatedEventAttributes = z.object({
  ...
  reason: z.string().describe('User/client provided reason for termination').optional(),
  details: z.any().optional(),
  /**id of the client who requested termination*/
  identity: z.string().describe('id of the client who requested termination').optional(),
});
