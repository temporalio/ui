...
export const WorkflowExecutionUpdateRejectedEventAttributes = z.object({
  ...
  protocolInstanceId: z
    .string()
    .describe('The instance ID of the update protocol that generated this event.')
    .optional(),
  /**
  ...
  rejectedRequest: z
    .any()
    .describe('The message payload of the original request message that initiated this\n update.')
    .optional(),
