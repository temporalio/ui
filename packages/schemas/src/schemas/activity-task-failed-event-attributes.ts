...
export const ActivityTaskFailedEventAttributes = z.object({
  ...
  scheduledEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_SCHEDULED` event this failure corresponds to')
    .optional(),
  /**The id of the `ACTIVITY_TASK_STARTED` event this failure corresponds to*/
  startedEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_STARTED` event this failure corresponds to')
    .optional(),
  /**id of the worker that failed this task*/
  identity: z.string().describe('id of the worker that failed this task').optional(),
  retryState: z
    .enum([
...
export type ActivityTaskFailedEventAttributes = z.infer<typeof ActivityTaskFailedEventAttributes>;
