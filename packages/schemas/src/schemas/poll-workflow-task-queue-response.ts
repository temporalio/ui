...
export const PollWorkflowTaskQueueResponse = z.object({
  ...
  taskToken: z.string().describe('A unique identifier for this task').optional(),
  ...
  attempt: z
    .number()
    .int()
    .describe('Starting at 1, the number of attempts to complete this task by any worker.')
    .optional(),
  /**
  ...
  pollerScalingDecision: z
    .any()
    .describe('Server-advised information the SDK may use to adjust its poller count.')
    .optional(),
});
export type PollWorkflowTaskQueueResponse = z.infer<typeof PollWorkflowTaskQueueResponse>;
