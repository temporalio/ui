...
export const Input = z.object({
  ...
  name: z
    .string()
    .describe('The name of the Update handler to invoke on the target Workflow.')
    .optional(),
  /**The arguments to pass to the named Update handler.*/
  args: z.any().describe('The arguments to pass to the named Update handler.').optional(),
});
