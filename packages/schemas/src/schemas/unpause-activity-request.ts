...
export const UnpauseActivityRequest = z.object({
  ...
  id: z.string().describe('Only the activity with this ID will be unpaused.').optional(),
  /**Unpause all running activities with of this type.*/
  type: z.string().describe('Unpause all running activities with of this type.').optional(),
  /**Unpause all running activities.*/
  unpauseAll: z.boolean().describe('Unpause all running activities.').optional(),
