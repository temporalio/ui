...
export const CreateWorkflowRuleRequest = z.object({
  ...
  requestId: z.string().describe('Used to de-dupe requests. Typically should be UUID.').optional(),
});
export type CreateWorkflowRuleRequest = z.infer<typeof CreateWorkflowRuleRequest>;
