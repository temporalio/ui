...
export const WorkflowTaskFailedEventAttributes = z.object({
  ...
  scheduledEventId: z
    .string()
    .describe('The id of the `WORKFLOW_TASK_SCHEDULED` event this task corresponds to')
    .optional(),
  /**The id of the `WORKFLOW_TASK_STARTED` event this task corresponds to*/
  startedEventId: z
    .string()
    .describe('The id of the `WORKFLOW_TASK_STARTED` event this task corresponds to')
    .optional(),
  cause: z
    .enum([
  ...
  newRunId: z.string().describe('If the workflow is being reset, the new run id.').optional(),
  /**TODO: ?*/
...
export type WorkflowTaskFailedEventAttributes = z.infer<typeof WorkflowTaskFailedEventAttributes>;
