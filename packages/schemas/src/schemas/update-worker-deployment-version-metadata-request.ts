...
export const UpdateWorkerDeploymentVersionMetadataRequest = z
  .object({
    ...
    version: z
      .string()
      .describe('Deployment Version identifier in the form "<deployment_name>.<build_id>".')
      .optional(),
  ...
  .describe('Used to update the user-defined metadata of a Worker Deployment Version.');
