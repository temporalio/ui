...
export const GetSystemInfoResponse_Capabilities = z
  .object({
    ...
    activityFailureIncludeHeartbeat: z
      .boolean()
      .describe('True if RespondActivityTaskFailed API supports including heartbeat details')
      .optional(),
    /**Supports scheduled workflow features.*/
    supportsSchedules: z.boolean().describe('Supports scheduled workflow features.').optional(),
    ...
    upsertMemo: z.boolean().describe('True if server supports upserting workflow memo').optional(),
...
export type GetSystemInfoResponse_Capabilities = z.infer<typeof GetSystemInfoResponse_Capabilities>;
