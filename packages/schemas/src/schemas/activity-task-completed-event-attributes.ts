...
export const ActivityTaskCompletedEventAttributes = z.object({
  ...
  result: z
    .any()
    .describe('Serialized results of the activity. IE: The return value of the activity function')
    .optional(),
  /**The id of the `ACTIVITY_TASK_SCHEDULED` event this completion corresponds to*/
  scheduledEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_SCHEDULED` event this completion corresponds to')
    .optional(),
  /**The id of the `ACTIVITY_TASK_STARTED` event this completion corresponds to*/
  startedEventId: z
    .string()
    .describe('The id of the `ACTIVITY_TASK_STARTED` event this completion corresponds to')
    .optional(),
  /**id of the worker that completed this task*/
  identity: z.string().describe('id of the worker that completed this task').optional(),
  /**
