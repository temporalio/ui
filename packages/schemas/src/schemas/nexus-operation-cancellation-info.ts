...
export const NexusOperationCancellationInfo = z
  .object({
    ...
    lastAttemptFailure: z.any().describe("The last attempt's failure, if any.").optional(),
    ...
    blockedReason: z
      .string()
      .describe('If the state is BLOCKED, blocked reason provides additional information.')
      .optional(),
  })
  .describe('NexusOperationCancellationInfo contains the state of a nexus operation cancellation.');
export type NexusOperationCancellationInfo = z.infer<typeof NexusOperationCancellationInfo>;
