...
export const MarkerRecordedEventAttributes = z.object({
  ...
  details: z.record(z.any()).describe('Serialized information recorded in the marker').optional(),
...
export type MarkerRecordedEventAttributes = z.infer<typeof MarkerRecordedEventAttributes>;
