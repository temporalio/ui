...
export const ScheduleActionResult = z.object({
  ...
  scheduleTime: z
    ...
    .describe('Time that the action was taken (according to the schedule, including jitter).')
    .optional(),
  ...
  startWorkflowResult: z.any().describe('If action was start_workflow:').optional(),
  /**
