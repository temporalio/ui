...
export const BatchOperationTermination = z
  .object({
    ...
    details: z.any().describe('Serialized value(s) to provide to the termination event').optional(),
...
export type BatchOperationTermination = z.infer<typeof BatchOperationTermination>;
