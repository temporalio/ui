...
export const SetWorkerDeploymentRampingVersionRequest = z
  .object({
    ...
    percentage: z.number().describe('Ramp percentage to set. Valid range: [0,100].').optional(),
    /**
    ...
    identity: z
      .string()
      .describe('Optional. The identity of the client who initiated this request.')
      .optional(),
    /**
  ...
  .describe('Set/unset the Ramping Version of a Worker Deployment and its ramp percentage.');
