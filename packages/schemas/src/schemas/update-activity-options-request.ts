...
export const UpdateActivityOptionsRequest = z.object({
  ...
  activityOptions: z
    .any()
    .describe('Activity options. Partial updates are accepted and controlled by update_mask')
    .optional(),
  ...
  id: z.string().describe('Only activity with this ID will be updated.').optional(),
  /**Update all running activities of this type.*/
  type: z.string().describe('Update all running activities of this type.').optional(),
});
export type UpdateActivityOptionsRequest = z.infer<typeof UpdateActivityOptionsRequest>;
