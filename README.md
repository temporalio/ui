...
To get a better representation of production data, you can run our UI with the [canary-go](github.com/temporalio/canary-go) repo. You will need go installed on your machine.
