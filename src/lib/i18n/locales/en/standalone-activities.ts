...
export const Strings = {
  ...
  worker: 'Worker',
  'run-state': 'Run State',
  'run-state-unspecified': 'Unspecified',
  'run-state-scheduled': 'Scheduled',
  'run-state-started': 'Started',
  'run-state-cancel-requested': 'Cancel Requested',
  'run-state-paused': 'Paused',
  'run-state-pause-requested': 'Pause Requested',
  attempt: 'Attempt',
