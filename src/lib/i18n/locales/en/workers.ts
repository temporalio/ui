...
export const Strings = {
  ...
  'min-instances-label': 'Min Replicas',
  'min-instances-hint': 'Minimum number of Cloud Run replicas to keep running.',
  'max-instances-label': 'Max Replicas',
  'max-instances-hint': 'Maximum number of Cloud Run replicas to scale to.',
