...
export const Strings = {
  ...
  'cache-size-description': 'Workflow Executions cached',
  'cache-hits': 'Cache Hit Rate',
  'cache-hits-description': '{{hits}} of 100 Workflow Tasks hit the cache',
  ...
  'lambda-arn-label': 'Lambda Function ARN',
  ...
  'external-id-placeholder': 'tmprl-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
  'external-id-help':
  ...
  'scale-down-stabilization-ms-label': 'Scale-down Stabilization (ms)',
  'scale-down-stabilization-ms-hint':
    'Wait this many ms after demand ends before scaling down. 0 = no wait. Default: 90000.',
  ...
  'open-lambda-console': 'Open Lambda Console',
  ...
  'resource-section-description':
    'Point Temporal Cloud at the resource to invoke.',
  'access-section': 'Access',
  'access-section-description': 'Enable Temporal Cloud to invoke your Worker.',
  'scaling-lifecycle-section': 'Scaling and Lifecycle',
  'scaling-lifecycle-description':
    'Optionally control how Temporal Cloud scales your Workers.',
  'no-role-prompt': "Don't have a role yet? Create one",
  'cfn-tab': 'CloudFormation',
  'terraform-tab': 'Terraform',
  'launch-stack-description':
    'Launch the stack in your AWS account. The template and parameters are pre-filled.',
  'launch-stack': 'Launch Stack',
  'download-template': 'Download Template Instead',
  'terraform-description-before': 'Use our Terraform ',
  ...
  'gcp-region-hint': 'The GCP region where your Cloud Run service runs.',
  'gcp-region-placeholder': 'us-central1',
  'gcp-worker-pool-label': 'Worker Pool',
  'gcp-worker-pool-placeholder': 'temporal-worker-pool',
  'gcp-service-account-label': 'Service Account',
  'gcp-service-account-hint':
