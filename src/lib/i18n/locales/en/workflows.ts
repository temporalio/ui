...
export const Strings = {
  ...
  'common-errors-error_one': '{{count}} error',
  'common-errors-error_other': '{{count}} errors',
  'common-errors-warning_one': '{{count}} warning',
  'common-errors-warning_other': '{{count}} warnings',
  'common-errors-info_one': '{{count}} info',
  'common-errors-info_other': '{{count}} info',
