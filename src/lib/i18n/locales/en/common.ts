...
export const Strings = {
  ...
  'unsaved-view': 'Unsaved view',
  unsaved: 'Unsaved',
  'save-as-new': 'Save as New',
  'edit-view': 'Edit View',
  'save-as-new-view': 'Save as New View',
  'view-name-placeholder': 'Name of view',
  'view-name-required': 'Name is required',
  'view-name-invalid-characters':
    'Use only letters, numbers, spaces, hyphens (-), underscores (_), and periods (.)',
  ...
  import: 'Import',
  feedback: 'Feedback',
  'upgrade-ready': 'Ready to upgrade?',
  'upgrade-available': 'New version available',
  'upgrade-new-version': 'New version',
  'upgrade-view-release': 'View release',
  'upgrade-reveal-label': 'Peel to reveal the new version of {{current}}',
  'upgrade-notice-label': 'Upgrade from {{current}} to {{latest}}',
  'dismiss-upgrade-notice': 'Dismiss upgrade notice',
  'log-out': 'Log out',
  ...
  'view-more': 'View More...',
  'view-all': 'View All',
  'view-all-runs-count_one': 'View 1 run',
