...
export const Strings = {
  ...
  'legend-filter': {
    'event-type-facet': 'Event type',
    'status-facet': 'Status',
    'refine-facet': 'Only show',
    'filter-by-event-type': 'Filter by event type',
    'filter-by-status': 'Filter by status',
    'refine-results': 'Only show matching events',
    'view-settings': 'View settings',
    'view-facet': 'View',
    'view-compact': 'Compact',
    'view-json': 'JSON',
    clear: 'Clear',
    'no-matches': 'No events match the current filters.',
    pending: 'Pending',
    retried: 'Retried',
    'completed-with-retries': 'Completed with retries',
  },
