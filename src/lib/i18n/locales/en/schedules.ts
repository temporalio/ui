...
export const Strings = {
  ...
  'spec-summary-everyday': 'Everyday {{- time}}',
  'spec-summary-weekdays': 'Weekdays {{- time}}',
  'spec-summary-weekends': 'Weekends {{- time}}',
  'spec-summary-week': 'Every {{- days}} {{- time}}',
  'spec-summary-month-every': 'On {{- days}} of every month {{- time}}',
  'spec-summary-month': 'On {{- days}} of {{- months}} {{- time}}',
