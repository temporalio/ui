...
export const Strings = {
  ...
  'standalone-activity-link': 'Standalone Activity Link',
  'standalone-nexus-operation-link': 'Standalone Nexus Operation Link',
  ...
  'handler-target-type': 'Handler Target Type',
  'target-type-standalone-activity': 'Standalone Activity',
  'target-type-workflow': 'Workflow',
