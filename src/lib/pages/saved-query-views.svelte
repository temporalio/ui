...
<div
  class={merge(
    'surface-primary border-subtle relative h-[var(--panel-h)] h-auto max-h-[var(--panel-h)] min-h-[var(--panel-h)] w-[var(--panel-collapsed-w)] max-w-[var(--panel-collapsed-w)] min-w-[var(--panel-collapsed-w)] overflow-auto border border-r-0 shadow-sm transition-all duration-300 ease-in-out',
    $savedQueryNavOpen
...
>
  ...
  >
    ...
    >
      ...
      <button
        class="hover:bg-secondary hidden rounded-sm p-0.5 lg:inline-flex"
