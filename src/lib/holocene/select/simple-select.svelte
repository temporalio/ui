...
<div>
  ...
  <select
    class={merge(
      'border-secondary text-primary dark:surface-primary inline h-10 w-full border bg-transparent px-2 text-base outline-hidden focus-visible:outline focus-visible:outline-blue-700',
