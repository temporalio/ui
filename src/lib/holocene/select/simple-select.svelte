...
<div>
  ...
  <select
    class={merge(
      'inline h-10 w-full rounded border border-tertiary bg-interactive-secondary px-2 text-base text-primary outline-none focus-visible:outline focus-visible:outline-interactive-primary',
