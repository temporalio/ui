...
<div class={merge('flex flex-col gap-1', $$props.class)}>
  ...
  <div class="flex items-center">
    <div
      class="surface-primary border-subtle focus-within:ring-primary/70 relative box-border flex h-10 min-w-16 items-center border text-sm focus-within:ring-2 focus-within:outline-none"
    ...
    >
      ...
      {/if}
      <input
        class="text-primary focus:text-brand m-2 block w-full bg-transparent text-center focus:outline-none"
        type="number"
        {max}
        {min}
        {disabled}
