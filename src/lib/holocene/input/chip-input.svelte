...
<style lang="postcss">
  ...
  .input-container {
    @apply flex max-h-20 min-h-[2.5rem] w-full flex-row flex-wrap gap-1 overflow-y-scroll rounded border border-slate-900 bg-white p-2 text-sm text-primary focus-within:border-blue-700;
