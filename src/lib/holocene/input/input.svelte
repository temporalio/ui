...
<style lang="postcss">
  ...
  .input-container {
    @apply surface-primary relative box-border inline-flex h-10 w-full items-center rounded border border-primary text-sm text-primary dark:focus-within:surface-primary focus-within:border-indigo-600 focus-within:shadow-focus focus-within:shadow-indigo-500/50 focus-within:outline-none dark:bg-transparent;
