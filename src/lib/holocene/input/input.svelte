...
<style lang="postcss">
  ...
  .input-container {
    @apply surface-primary relative box-border inline-flex h-10 w-full items-center rounded border border-subtle text-sm dark:focus-within:surface-primary focus-within:border-interactive focus-within:shadow-focus focus-within:shadow-primary/50 focus-within:outline-none dark:bg-transparent;
