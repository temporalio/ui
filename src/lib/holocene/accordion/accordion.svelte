  ...
  >
    <div class="flex w-full flex-row items-center">
      <button
        ...
        class="focus-visible:bg-interactive-secondary-hover flex grow flex-col p-4 focus-visible:outline-hidden"
        type="button"
...
{:else}
  <div
    class="surface-primary border-subtle w-full border p-4"
    data-track-container={title}
    {...$$restProps}
  >
