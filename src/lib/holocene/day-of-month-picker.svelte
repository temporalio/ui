...
<div
  class="surface-primary border-subtle grid place-items-center gap-1 rounded border px-0 py-4 text-center sm:gap-4 md:gap-x-8 md:px-2 xl:gap-x-16 xl:px-4"
>
