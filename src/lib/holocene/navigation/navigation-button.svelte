...
<div
  ...
  class={merge(
    'relative mb-2 flex items-center pl-1 text-sm whitespace-nowrap hover:hover:bg-black/25 group-[.surface-black]:hover:bg-black/25 group-[.surface-black]:hover:bg-white',
