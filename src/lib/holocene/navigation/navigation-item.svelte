...
>
  <a
    ...
    class={merge(
      ...
      'hover:bg-opacity-25 group-[.surface-black]:hover:bg-opacity-25 hover:bg-black group-[.surface-black]:hover:bg-white',
      active &&
        'bg-opacity-25 group-[.surface-black]:bg-opacity-25 bg-black group-[.surface-black]:bg-white',
