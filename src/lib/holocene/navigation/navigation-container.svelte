...
<nav
  class={merge(
    'group grid min-h-full grid-cols-[2rem] grid-rows-[fit-content(1.5rem)] gap-2 border-r border-subtle px-2 py-4 transition-width data-[nav=closed]:w-[calc(3rem_+_1px)] data-[nav=open]:w-[13.125rem] data-[nav=open]:grid-cols-[100%] motion-reduce:transition-none',
