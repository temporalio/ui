...
<nav
  class={merge(
    ...
    isCloud
      ? 'bg-gradient-to-b from-indigo-600 to-indigo-950 text-off-white data-[nav=open]:w-[16rem] focus-visible:[&_[role=button]]:outline-none focus-visible:[&_[role=button]]:ring-2 focus-visible:[&_[role=button]]:ring-success focus-visible:[&_a]:ring-success'
      : 'surface-black',
  )}
