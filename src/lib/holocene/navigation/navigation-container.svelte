...
<nav
  class={merge(
    ...
    isCloud
      ? 'bg-gradient-to-b from-indigo-600 to-indigo-950 text-io-content-white focus-visible:[&_[role=button]]:outline-none focus-visible:[&_[role=button]]:ring-2 focus-visible:[&_[role=button]]:ring-io-green-7 focus-visible:[&_a]:ring-io-green-7'
