...
<div class={merge('group flex flex-col gap-1', className)}>
  ...
  <div
    class={merge(
      'relative box-border inline-flex w-full rounded-lg border border-subtle focus-within:border-information focus-within:ring-4 focus-within:ring-primary/70',
      !isValid && 'error',
