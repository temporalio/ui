...
<button
  class={merge(
    'surface-interactive-secondary focus-visible:ring-primary/70 m-1 border border-[transparent] bg-transparent p-1 focus-visible:ring-2 focus-visible:outline-none',
    className,
  )}
  {onclick}
>
