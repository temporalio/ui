...
<style lang="postcss">
  .link {
    @apply max-w-fit cursor-pointer  gap-2 rounded text-primary underline underline-offset-2 hover:text-active focus-visible:text-active focus-visible:shadow-focus focus-visible:shadow-indigo-600/50 focus-visible:outline-none;
