...
<style lang="postcss">
  ...
  .combobox-wrapper {
    @apply surface-primary flex h-10 w-full flex-row  rounded-lg border border-primary text-sm dark:focus-within:surface-primary focus-within:border-interactive focus-within:shadow-focus focus-within:shadow-primary/50 focus-within:outline-none dark:bg-transparent;
  ...
  .combobox-button {
    @apply mx-2 flex shrink-0  justify-center rounded-full hover:surface-interactive-secondary;
  }
</style>
