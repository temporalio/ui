...
<style lang="postcss">
  .chip {
    @apply flex h-8 w-fit min-w-fit flex-row items-center justify-between gap-1 whitespace-nowrap break-all rounded-md border border-subtle bg-slate-50 p-1 text-sm text-slate-700;
