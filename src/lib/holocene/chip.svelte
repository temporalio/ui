...
<style lang="postcss">
  .chip {
    @apply surface-subtle flex min-h-7 w-fit min-w-fit flex-row items-center justify-between gap-1 rounded-sm p-1.5 text-sm leading-[1.5] break-all whitespace-nowrap;
