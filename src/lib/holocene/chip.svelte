...
<style lang="postcss">
  .chip {
    @apply surface-subtle flex h-8 w-fit min-w-fit flex-row items-center justify-between gap-1 whitespace-nowrap break-all rounded-md border border-subtle p-1 text-sm text-primary;
