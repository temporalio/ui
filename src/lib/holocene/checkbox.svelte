...
<style lang="postcss">
  ...
  .checkmark {
    @apply relative box-content flex h-4 w-4 flex-none cursor-pointer rounded-md border-2 border-subtle bg-transparent text-white outline outline-4 outline-transparent hover:border-transparent hover:border-white hover:bg-interactive hover:outline-[*insert color here*] dark:text-black hover:dark:border-black;
