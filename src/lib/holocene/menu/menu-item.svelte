...
<style lang="postcss">
  .menu-item {
    @apply m-1 flex cursor-pointer flex-row items-center gap-2 rounded border border-transparent px-3 py-2 font-primary text-sm font-medium focus-visible:surface-interactive-secondary focus-visible:shadow-primary dark:hover:surface-interactive hover:bg-interactive/10 focus-visible:border-interactive focus-visible:border-inverse focus-visible:outline-none dark:focus-visible:border-interactive;
