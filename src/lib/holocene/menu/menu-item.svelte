...
<style lang="postcss">
  ...
  .menu-item {
    @apply focus-visible:border-inverse focus-visible:ring-primary/70 dark:focus-visible:border-interactive cursor-pointer border border-transparent text-sm focus-visible:ring-2 focus-visible:outline-hidden;
