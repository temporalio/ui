...
<style lang="postcss">
  ...
  .bulk-action-button.primary {
    @apply border-white bg-primary from-blue-100 to-purple-100 hover:border-gray-900 hover:bg-gradient-to-br hover:text-gray-900 dark:border-gray-100;
  }

  .bulk-action-button.destructive {
    @apply border-danger bg-danger hover:border-red-900 hover:bg-red-900;
  }
