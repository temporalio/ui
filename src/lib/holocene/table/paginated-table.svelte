...
<style lang="postcss">
  ...
  .paginated-table-body {
    ...
    :global(tr:not(.empty)) {
      @apply h-12 border-b border-table last-of-type:border-0;
      @apply dark:hover:bg-gradient-to-br dark:hover:from-indigo-100 dark:hover:to-indigo-700 dark:hover:bg-fixed dark:hover:text-inverse;
      @apply hover:surface-subtle dark:hover:text-inverse;
    }
