...
describe('shared workflow corpus', () => {
  ...
  it('declares every catalog-owned corpus source so generated artifact verification catches drift', () => {
    expect(workflowCatalogRegistrationSource.sourceFiles).toEqual([
      ...
      'src/lib/workflow-catalog/node/examples/signal-collector/example.ts',
      'src/lib/workflow-catalog/node/examples/signal-collector/workflow.ts',
      'src/lib/workflow-catalog/node/examples/signal-collector/activity.ts',
