 ...
 */
export const workflowCatalogSharedStartOptionsSchema = {
  details: { type: 'string' },
...
export const workflowCatalogSharedStartOptionNames = Object.keys(
  workflowCatalogSharedStartOptionsSchema,
);
 ...
 */
export const withSharedWorkflowCatalogStartOptions = (
  schema: JsonSchema,
): JsonSchema => {
