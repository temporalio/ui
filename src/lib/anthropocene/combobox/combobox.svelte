<script lang="ts">
  ...
  import ComboboxOption from '$lib/anthropocene/combobox/combobox-option.svelte';
  import Label from '$lib/anthropocene/label.svelte';
  import MenuContainer from '$lib/anthropocene/menu/menu-container.svelte';
  import Menu from '$lib/anthropocene/menu/menu.svelte';
