...
} from './to-list-workflow-advanced-parameters';
...
describe('toListWorkflowParameters', () => {
  ...
  it('should parse a query with an executionStatus', () => {
    const result = toListWorkflowAdvancedParameters(executionStatusQuery, attributes);
  ...
  it('should parse a query with multiple executionStatuses', () => {
    const result = toListWorkflowAdvancedParameters(multipleExecutionStatusQuery, attributes);
    const expectedFilters = [{
      "attribute": "ExecutionStatus",
      "conditional": "=",
      "operator": "OR",
  ...
  it('should parse a query with an workflowId', () => {
    const result = toListWorkflowAdvancedParameters(workflowIdQuery, attributes);
    const expectedFilters = [{
  ...
  it('should parse a query with an workflowType', () => {
    const result = toListWorkflowAdvancedParameters(workflowTypeQuery, attributes);
    const expectedFilters = [{
