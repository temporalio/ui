...
describe('API Request Encoding', () => {
  it('should return a route for workflow', () => {
    ...
    expect(route).toBe(
      'http://localhost:8233/namespaces/namespace/workflows/workflow%2523with%2523hashes',
    );
  });
  ...
  it('should handle slashes', () => {
    ...
    expect(route).toBe(
      'http://localhost:8233/namespaces/canary/workflows/temporal.canary.cron-workflow.sanity-2022-05-02T16%253A03%253A11-06%253A00%252Fworkflow.advanced-visibility.scan',
    );
  });
});
