...
<div class="relative pb-24">
  <div
    class="surface-background border-subtle sticky top-0 z-[11] flex flex-wrap items-center justify-between gap-2 border-b pb-2 md:top-[var(--top-nav-height)] md:pt-2 xl:gap-8"
  >
