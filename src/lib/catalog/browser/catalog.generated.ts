...
export const catalogArtifact: BrowserCatalogArtifact = {
  sourceHash:
    '3b6baedfacc848f9baee952518fb3544ae9a8f9b0d5b25c85a99c03348d2d6fa',
  descriptors: [
    {
    ...
    },
    {
      ...
      description:
        'Runs 20 activities by default with summaries that alternate between a paragraph break and a hard break.',
      capabilityTags: ['activities', 'sequencing'],
      expectedEvidence: [
        'The configured number of non-overlapping activity executions in deterministic order.',
