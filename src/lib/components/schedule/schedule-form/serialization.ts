...
import type { RangeSpec, Schedule } from '$lib/types';
import type {
  FullSchedule,
  ScheduleInterval,
  ScheduleRequestBody,
...
// Inverse of `formDataToCreateScheduleRequest`/`formDataToEditScheduleRequest`:
// reads a Describe response (or `null` when creating) into the flat
// `ScheduleFormData`.
...
// ---------------------------------------------------------------------------
// Form data -> Create/Update request body
// ---------------------------------------------------------------------------
...
export const formDataToCreateScheduleRequest = async (
  formData: ScheduleFormData,
...
export const formDataToEditScheduleRequest = async (
  formData: ScheduleFormData,
  schedule: Schedule,
  scheduleId: string,
): Promise<ScheduleRequestBody> => {
...
const encodeHeaderFields = async (
