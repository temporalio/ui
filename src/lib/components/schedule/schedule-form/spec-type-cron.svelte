...
<div class="flex flex-col gap-4">
  ...
  <button
    type="button"
    class="mr-auto rounded-sm underline outline-none hover:text-brand focus:ring-2 focus:ring-interactive-primary focus:ring-offset-2 focus:ring-offset-background-primary"
