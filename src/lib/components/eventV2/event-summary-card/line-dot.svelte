...
<div
  class="z-[999] flex w-[100px] min-w-[100px] pt-[4px] flex-col items-end break-word leading-0 truncate text-right text-[12px] text-gray-700 md:whitespace-normal"
...
<div class="flex w-[20px] min-w-[20px] flex-col items-center justify-center">
  <div class="flex h-[24px] w-[10x] gap-0" class:running-line={running}>
    <div class="w-[4px]" />
    <div
      class="line"
