export { default as DetailList } from './detail-list.svelte';
export { default as DetailListLabel } from './detail-list-label.svelte';
export { default as DetailListValue } from './detail-list-value.svelte';
