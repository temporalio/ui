<script lang="ts">
  ...
  import EventListItem from '$lib/components/event/event-list-item.svelte';
  ...
  >
    ...
    <div class="flex">
      ...
      <div class="flex flex-col w-2/3">
        <div
          class="overflow-y-scroll overflow-x-hidden rounded-br-lg px-4 w-full py-4 sticky top-0"
        >
          <slot />
        </div>
      </div>
