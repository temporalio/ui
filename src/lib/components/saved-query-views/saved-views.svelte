...
<div class="flex">
  <div
    class={merge(
      'surface-primary relative min-h-[var(--panel-h)] w-[var(--panel-collapsed-w)] min-w-[var(--panel-collapsed-w)] max-w-[var(--panel-collapsed-w)] border border-r-0 border-subtle shadow-sm transition-all duration-300 ease-in-out',
      $savedQueryNavOpen
  ...
  >
    <div
      class="max-h-[var(--panel-h)] overflow-auto md:sticky md:top-[var(--scroll-inset-top)]"
    >
      <div
        class="flex h-12 items-center justify-center gap-2 border-b border-subtle px-2 text-center lg:justify-start"
      >
        <div
          class={merge(
