    ...
    ],
    {
      variants: {
        status: {
          ...
          TimedOut: 'bg-io-surface-status-persimmon text-io-content-error',
          Completed: 'bg-io-surface-status-green text-io-content-success',
          Failed: 'bg-io-surface-status-red text-io-content-danger',
          ContinuedAsNew: 'bg-io-alpha-purple-30 text-io-content-primary',
          Canceled: 'bg-io-surface-status-neutral text-io-content-primary',
          Terminated: 'bg-io-surface-status-amber text-io-content-warning',
          Paused: 'bg-io-surface-status-amber text-io-content-warning',
          Unspecified: 'bg-io-surface-status-neutral text-io-content-primary',
          Scheduled: 'bg-io-surface-status-blue text-io-content-information',
          Started: 'bg-io-surface-status-blue text-io-content-information',
          Open: 'bg-io-surface-status-green text-io-content-success',
          New: 'bg-io-surface-status-blue text-io-content-information',
          Initiated: 'bg-io-surface-status-blue text-io-content-information',
          Fired: 'bg-io-alpha-pink-30 text-io-content-primary',
          CancelRequested: 'bg-io-surface-status-amber text-io-content-warning',
          Signaled: 'bg-io-alpha-pink-30 text-io-content-primary',
          Pending: 'bg-io-alpha-purple-30 text-io-content-primary',
          Retrying: 'bg-io-surface-status-red text-io-content-danger',
        },
      },
    },
  );
  ...
  >
    ...
    {#if taskFailure}
      <span
        class={merge(
          workflowStatus(),
          'bg-io-surface-status-red text-io-content-danger',
          'rounded-l-none',
