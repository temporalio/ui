...
export const deployment: Step[] = [
  ...
  },
  {
    ...
    expectedStartTime: '2024-06-12 UTC 20:50:00.00',
    startTime: '',
    endTime: '',
    target_cell: 'cell4',
  },
  {
    ...
    type: StepType.DEPLOYMENT,
    status: StepStatus.SCHEDULED,
    expectedStartTime: '2024-06-12 UTC 21:30:00.00',
    startTime: '',
    endTime: '',
    target_cell: 'cell5',
  },
  {
    ...
    type: StepType.DEPLOYMENT,
    status: StepStatus.SCHEDULED,
    expectedStartTime: '2024-06-12 UTC 22:30:00.00',
    startTime: '',
    endTime: '',
    target_cell: 'cell6',
  },
  {
    ...
    type: StepType.DEPLOYMENT,
    status: StepStatus.SCHEDULED,
    expectedStartTime: '2024-06-12 UTC 23:30:00.00',
    startTime: '',
    endTime: '',
    target_cell: 'cell7',
  },
  {
    ...
    type: StepType.DEPLOYMENT,
    status: StepStatus.SCHEDULED,
    expectedStartTime: '2024-06-12 UTC 23:50:00.00',
    startTime: '',
    endTime: '',
    target_cell: 'cell8',
  },
