...
{#if cause && cause !== 'ResetWorkflow'}
  ...
  >
    ...
    {/if}
    <div
      class="mt-2 flex w-full flex-col gap-0 overflow-hidden border border-io-border-danger"
    >
      <div
        class="flex items-center justify-between gap-2 bg-io-surface-danger px-2 py-2"
      >
        <div class="flex items-center gap-2">
          ...
          />
          <span class="font-semibold text-io-content-danger"
