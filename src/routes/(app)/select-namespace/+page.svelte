...
<style lang="postcss">
  .link-item {
    @apply bg-solid flex border-collapse cursor-pointer gap-2 border border-x border-gray-900 from-blue-100 to-purple-100 hover:bg-gradient-to-br dark:border-gray-100;
  }
